...
import de.vanita5.microblog.library.twitter.api.HelpResources;
import de.vanita5.microblog.library.twitter.api.ListResources;
import de.vanita5.microblog.library.twitter.api.MutesResources;
import de.vanita5.microblog.library.twitter.api.PlacesGeoResources;
import de.vanita5.microblog.library.twitter.api.SavedSearchesResources;
import de.vanita5.microblog.library.twitter.api.SearchResources;
import de.vanita5.microblog.library.twitter.api.SpamReportingResources;
import de.vanita5.microblog.library.twitter.api.TimelineResources;
import de.vanita5.microblog.library.twitter.api.TrendsResources;
import de.vanita5.microblog.library.twitter.api.TweetResources;
