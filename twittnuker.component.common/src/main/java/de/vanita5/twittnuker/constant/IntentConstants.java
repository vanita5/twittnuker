...
public interface IntentConstants {
	...
	public static final String INTENT_ACTION_RETWEET = INTENT_PACKAGE_PREFIX + "RETWEET";
	public static final String INTENT_ACTION_FAVORITE = INTENT_PACKAGE_PREFIX + "FAVORITE";
	...
	public static final String INTENT_ACTION_PUSH_NOTIFICATION_CLEARED = INTENT_PACKAGE_PREFIX + "PUSHNOTIFICATION_CLEARED";
