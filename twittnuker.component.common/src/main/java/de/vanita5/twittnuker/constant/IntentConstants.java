...
public interface IntentConstants {
    ...
    String INTENT_PACKAGE_PREFIX = "de.vanita5.twittnuker.";
    ...
    String INTENT_ACTION_TAKE_PHOTO = INTENT_PACKAGE_PREFIX + "TAKE_PHOTO";
    String INTENT_ACTION_PICK_IMAGE = INTENT_PACKAGE_PREFIX + "PICK_IMAGE";
    ...
    String INTENT_ACTION_RETWEET = INTENT_PACKAGE_PREFIX + "RETWEET";
    String INTENT_ACTION_FAVORITE = INTENT_PACKAGE_PREFIX + "FAVORITE";
    ...
    String INTENT_ACTION_PUSH_NOTIFICATION_CLEARED = INTENT_PACKAGE_PREFIX + "PUSHNOTIFICATION_CLEARED";
