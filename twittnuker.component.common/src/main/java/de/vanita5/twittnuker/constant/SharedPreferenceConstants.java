...
import static de.vanita5.twittnuker.SecretConstants.TWITTER_CONSUMER_KEY;
import static de.vanita5.twittnuker.SecretConstants.TWITTER_CONSUMER_SECRET;
...
public interface SharedPreferenceConstants {
    ...
    int VALUE_TAB_DISPLAY_OPTION_CODE_BOTH = VALUE_TAB_DISPLAY_OPTION_CODE_LABEL
    ...
    String DEFAULT_THEME = VALUE_THEME_NAME_AUTO;
    String DEFAULT_THEME_BACKGROUND = VALUE_THEME_BACKGROUND_DEFAULT;
    String DEFAULT_THEME_FONT_FAMILY = VALUE_THEME_FONT_FAMILY_LIGHT;
    ...
    boolean DEFAULT_NEW_FOLLOWERS_NOTIFICATION = true;

    int DEFAULT_DATABASE_ITEM_LIMIT = 100;
    int DEFAULT_LOAD_ITEM_LIMIT = 100;
    ...
    @Preference(type = BOOLEAN, hasDefault = true, defaultBoolean = false)
    String KEY_STREAMING_AUTOSCROLL = "stream_autoscroll";
    @Preference(type = BOOLEAN, hasDefault = true, defaultBoolean = true)
    String KEY_REFRESH_BEFORE_STREAMING = "refresh_before_streaming";
    @Preference(type = BOOLEAN, hasDefault = true, defaultBoolean = false)
    String KEY_STREAMING_ON_MOBILE = "stream_on_mobile";
    @Preference(type = BOOLEAN, hasDefault = true, defaultBoolean = true)
    String KEY_STREAMING_NOTIFICATIONS = "stream_notifications";
    @Preference(type = BOOLEAN, hasDefault = true, defaultBoolean = false)
