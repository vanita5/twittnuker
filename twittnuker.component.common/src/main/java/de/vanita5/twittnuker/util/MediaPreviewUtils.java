...
public class MediaPreviewUtils {
    ...
    private static final Pattern[] SUPPORTED_PATTERNS = {PATTERN_GENERIC, PATTERN_TWITTER_IMAGES, PATTERN_INSTAGRAM,
            PATTERN_GOOGLE_IMAGES, PATTERN_GOOGLE_PROXY_IMAGES, PATTERN_SINA_WEIBO_IMAGES, PATTERN_IMGUR,
            PATTERN_IMGLY, PATTERN_YFROG, PATTERN_LOCKERZ, PATTERN_PLIXI, PATTERN_TWITGOO, PATTERN_MOBYPICTURE,
            PATTERN_PHOTOZOU, PATTERN_TWITTER_DM_IMAGES, PATTERN_ABLOAD, PATTERN_TWIPPLE};
    ...
    public static ParcelableMedia getAllAvailableImage(final String link, final boolean fullImage,
        ...
        if (m.matches())
            return getTwippleImage(RegexUtils.matcherGroup(m, TWIPPLE_GROUP_ID), link);
