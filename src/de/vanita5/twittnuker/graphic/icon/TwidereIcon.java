...
public enum TwidereIcon implements Icon {
	TWITTNUKER(0xF000), WEB(0xF001), COMPOSE(0xF002), COLOR_PALETTE(0xF003), CAMERA(0xF004), NEW_MESSAGE(0xF005), SERVER(
            ...
            0xF030), INTERFACE(0xF031), BLOCK(0xF032), WARNING(0xF033), HEART(0xF100);
