...
public class ActionIconsInterceptor implements AccentResources.Interceptor {
    ...
    static {
        sIconMap.put(R.drawable.ic_iconic_action_twittnuker, TwidereIcon.TWITTNUKER);
        sIconMap.put(R.drawable.ic_iconic_action_twittnuker_square, TwidereIcon.TWITTNUKER_SQUARE);
