...
import de.vanita5.twittnuker.graphic.TextDrawable;
...
public class ActionIconsInterceptor implements DrawableInterceptor {
    ...
    static {
        ...
        sIconMap.put(R.drawable.ic_iconic_action_twittnuker_square, new IconSpec(TwidereIcon.TWITTNUKER_SQUARE, 0.875f));
