...
import static de.vanita5.twittnuker.util.ThemeUtils.getThemeResource;
import static de.vanita5.twittnuker.util.ThemeUtils.setPreviewView;
...
public class ThemePreviewPreference extends Preference implements Constants, OnSharedPreferenceChangeListener {
	...
	public void onSharedPreferenceChanged(final SharedPreferences preferences, final String key) {
		if (PREFERENCE_KEY_THEME.equals(key) || PREFERENCE_KEY_THEME_BACKGROUND.equals(key)
				|| PREFERENCE_KEY_THEME_COLOR.equals(key)) {
			notifyChanged();
		}
	}
