...
public interface TweetStore {
	...
	public static interface Statuses extends BaseColumns {
		...
		public static final String[] COLUMNS = new String[]{_ID, ACCOUNT_ID, STATUS_ID, USER_ID,
				...
				IS_GAP, IS_POSSIBLY_SENSITIVE, MEDIAS, FIRST_MEDIA, MENTIONS};
	...
	public static interface Tabs extends BaseColumns {
		...
		public static final String[] TYPES = new String[] { TYPE_PRIMARY_KEY, TYPE_TEXT, TYPE_TEXT_NOT_NULL, TYPE_TEXT,
