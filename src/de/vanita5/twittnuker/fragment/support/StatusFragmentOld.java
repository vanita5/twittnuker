...
public class StatusFragmentOld extends ParcelableStatusesListFragment implements OnClickListener,
...
//                }
	...
	public void displayStatus(final ParcelableStatus status) {
		...
		final String in_reply_to = getDisplayName(status.in_reply_to_name, status.in_reply_to_screen_name, nameFirst);
	...
	public void onClick(final View view) {
		...
		switch (view.getId()) {
            ...
            case R.id.reply_retweet_status: {
				showConversation();
				break;
			}
...
//			}
	...
	public View onCreateView(final LayoutInflater inflater, final ViewGroup container, final Bundle savedInstanceState) {
        ...
        mImagePreviewContainer = mHeaderView.findViewById(R.id.media_preview);
        ...
        mInReplyToView = (TextView) mHeaderView.findViewById(R.id.reply_retweet_status);
...
//        mLoadImagesIndicator = mHeaderView.findViewById(R.id.media_preview_load);
		...
		public void onClick(final DialogInterface dialog, final int which) {
			switch (which) {
				case DialogInterface.BUTTON_POSITIVE: {
                    ...
                    if (f instanceof StatusFragmentOld) {
                        ((StatusFragmentOld) f).loadPreviewImages();
					}
					break;
				}
			}
	...
	static class LoadConversationTask extends TwidereAsyncTask<ParcelableStatus, Void, SingleResponse<Boolean>> {
        ...
        final StatusFragmentOld fragment;

        LoadConversationTask(final StatusFragmentOld fragment) {
