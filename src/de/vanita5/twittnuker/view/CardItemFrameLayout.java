...
public class CardItemFrameLayout extends ColorLabelFrameLayout {
	...
	public CardItemFrameLayout(final Context context, final AttributeSet attrs, final int defStyle) {
