...
package de.vanita5.twittnuker.view.holder;import android.content.Context;
...
public class StatusListViewHolder extends CardViewHolder {
	...
	public void setStatusType(final boolean is_favorite, final boolean has_location, final boolean has_media,
							  ...
							  final boolean is_reply) {
		final int res = getStatusTypeIconRes(is_favorite, has_location, has_media,
				is_possibly_sensitive, is_retweeted_by_me, is_reply);
