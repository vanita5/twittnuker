...
class LinkHandlerActivity : BaseActivity(), SystemWindowsInsetsCallback, IControlBarActivity, SupportFragmentCallback {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        try {
            ...
            if (accountHost == null) {
                accountHost = uri.getQueryParameter(TwittnukerConstants.QUERY_PARAM_ACCOUNT_HOST)
            }
        ...
        ft.commit()
        setTitle(linkId, uri)
        mFinishOnly = java.lang.Boolean.parseBoolean(uri.getQueryParameter(TwittnukerConstants.QUERY_PARAM_FINISH_ONLY))
    ...
    private fun setTitle(linkId: Int, uri: Uri): Boolean {
        ...
        when (linkId) {
            ...
            Constants.LINK_ID_USER_FAVORITES -> {
                if (mPreferences.getBoolean(SharedPreferenceConstants.KEY_I_WANT_MY_STARS_BACK)) {
            ...
            Constants.LINK_ID_SEARCH -> {
                ...
                setSubtitle(uri.getQueryParameter(TwittnukerConstants.QUERY_PARAM_QUERY))
            }
