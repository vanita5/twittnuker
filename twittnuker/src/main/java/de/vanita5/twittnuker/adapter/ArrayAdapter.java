...
public class ArrayAdapter<T> extends BaseAdapter implements Filterable {
     ...
     * @param objects  The objects to represent in the ListView.
     */
    public ArrayAdapter(Context context, int resource, Collection<? extends T> objects) {
    ...
    private void init(Context context, int resource, Collection<? extends T> objects) {
        mContext = context;
