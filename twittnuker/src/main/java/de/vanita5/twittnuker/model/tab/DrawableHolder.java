...
public abstract class DrawableHolder {
    ...
    public static class Builtin extends DrawableHolder {
        ...
        public static final Builtin TWITTNUKER = new Builtin("twittnuker", R.drawable.ic_action_twitter);
        ...
        public static final Builtin COMP = new Builtin("comp", R.drawable.ic_action_comp);
        public static final Builtin CTHULHU = new Builtin("cthulhu", R.drawable.ic_action_cthulhu);
        public static final Builtin HARVEY = new Builtin("harvey", R.drawable.ic_action_harvey);
        public static final Builtin MAJORA = new Builtin("majora", R.drawable.ic_action_heart_z);
        public static final Builtin METROID = new Builtin("metroid", R.drawable.ic_action_metroid);
        public static final Builtin NYARLATHOREPIRYCX = new Builtin("nyarlathorepirycx", R.drawable.ic_action_nyarlathorepirycx);
        public static final Builtin POKEBALL = new Builtin("pokeball", R.drawable.ic_action_pokeball);
        public static final Builtin TRIFORCE = new Builtin("triforce", R.drawable.ic_action_triforce);
