...
public class ThemeUtils implements Constants {
    ...
    public static void applyActionBarBackground(final ActionBarContainer actionBar, final Context context,
                                                final int actionBarColor, String backgroundOption, boolean outlineEnabled) {
        if (actionBar == null || context == null) return;
        actionBar.setPrimaryBackground(getActionBarBackground(context,  actionBarColor, backgroundOption, outlineEnabled));
        actionBar.setSplitBackground(getActionBarSplitBackground(context));
        actionBar.setStackedBackground(getActionBarStackedBackground(context,  actionBarColor, backgroundOption, outlineEnabled));
    }
