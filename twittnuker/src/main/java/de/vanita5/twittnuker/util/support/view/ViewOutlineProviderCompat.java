...
package de.vanita5.twittnuker.util.support.view;
...
import de.vanita5.twittnuker.util.support.DrawableSupport;
import de.vanita5.twittnuker.util.support.graphics.OutlineCompat;

/**
 * Interface by which a View builds its {@link de.vanita5.twittnuker.util.support.graphics.OutlineCompat}, used for shadow casting and clipping.
 */
