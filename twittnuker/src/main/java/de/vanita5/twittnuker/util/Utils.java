...
//        Utils.scrollListToPosition(view, position, offset);
	...
	public static Twitter getTwitterInstance(final Context context, final long accountId,
											 final boolean includeEntities,
											 final boolean includeRetweets) {
		return getTwitterInstance(context, accountId, includeEntities, includeRetweets, null, null);
	}
	...
	public static Twitter getTwitterInstance(final Context context, final long accountId,
		...
		return getTwitterInstance(context, accountId, false, false, mediaProvider, mediaProviderKey);
	}
	...
	public static Twitter getTwitterInstance(final Context context, final long accountId,
											 ...
											 final String mediaProviderAPIKey) {
		if (context == null) return null;
