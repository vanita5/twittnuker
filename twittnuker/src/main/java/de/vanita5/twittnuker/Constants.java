...
public interface Constants extends TwittnukerConstants {
	...
	public static final int DATABASES_VERSION = 89;
	...
	public static final int[] PRESET_COLORS = {R.color.material_dark, R.color.material_light, R.color.material_red, R.color.material_pink,
