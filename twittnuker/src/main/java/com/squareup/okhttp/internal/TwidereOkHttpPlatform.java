...
public class TwidereOkHttpPlatform extends Platform implements Constants {
    ...
    private TwidereOkHttpPlatform(TwittnukerApplication application, Method trafficStatsTagSocket, Method trafficStatsUntagSocket) {
        this.application = application;
        this.trafficStatsTagSocket = trafficStatsTagSocket;
        this.trafficStatsUntagSocket = trafficStatsUntagSocket;
}

    public static void applyHack(TwittnukerApplication application) {
    ...
    public static TwidereOkHttpPlatform get(TwittnukerApplication application) {
