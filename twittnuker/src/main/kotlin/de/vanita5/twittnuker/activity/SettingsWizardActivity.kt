...
import de.vanita5.twittnuker.fragment.wizard.WizardWelcomePageFragment
...
class SettingsWizardActivity : BaseActivity() {
    ...
    internal abstract class AbsInitialSettingsTask(protected val activity: SettingsWizardActivity) : AsyncTask<Any, Any, Boolean>() {
        ...
        companion object {
            ...
            private val DEFAULT_TAB_TYPES = arrayOf(CustomTabType.HOME_TIMELINE, CustomTabType.NOTIFICATIONS_TIMELINE, CustomTabType.DIRECT_MESSAGES, CustomTabType.TRENDS_SUGGESTIONS)
        }
